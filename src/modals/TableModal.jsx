...
import Table from '../modelUI/Table';

const TableModal = ({ show, onHide, model, action }) => {
    ...
    useEffect(() => {
        let fileList = [];
        if (model.images.startsWith("http") || model.images.endsWith(".png")) {
            fileList.push({
                status: 'done',
                url: model.images,
            });
